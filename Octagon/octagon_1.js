...
*/
    ...
    f1.add(controller, 'corner_br_ratio', 0.15, 1.1).onChange( function() 
	{
    ...
    f2.add(controller, 'angle_B0', 10, 80).onChange( function() 
	{
		var temp = angle_B0;
		orbitControl.enabled = false;
    ...
    f2.add(controller, 'angle_B1', 10, 80).onChange( function() 
	{
		var temp = angle_B1;
		orbitControl.enabled = false;
    ...
    f2.add(controller, 'angle_A0', 10, 98).onChange( function() 
	{
		var temp = angle_A0;
		orbitControl.enabled = false;
...
function pars_value()
{
	...
	h = h + dh;
	var text = "Corner break ratio ";
	ctx.fillStyle = text_color;
	ctx.fillText(text, w1, h);		
	text = roundNumber(corner_break_ratio, 2);
	ctx.fillStyle = value_color;
	ctx.fillText(text, w2, h);		
	
	h = h + dh;
	text = "Corner break angle";
	ctx.fillStyle = text_color;
	ctx.fillText(text, w1, h);	
	text = roundNumber(corner_break_angle/DEGREE, 3) + "°";
	ctx.fillStyle = value_color;
	ctx.fillText(text, w2, h);
	...
	ctx.fillStyle = text_color;
	ctx.fillText(text, w1, h);	
	text = roundNumber(angle_B0/DEGREE, 3) + "°";
	ctx.fillStyle = value_color;
	ctx.fillText(text, w2, h);	
	
	h = h + dh;
	text = "Up corner crown angle";
	ctx.fillStyle = text_color;
	ctx.fillText(text, w1, h);	
	text = roundNumber(angle_B1/DEGREE, 3) + "°";
	ctx.fillStyle = value_color;
	ctx.fillText(text, w2, h);	
	...
	ctx.fillStyle = text_color;
	ctx.fillText(text, w1, h);	
	text = roundNumber(angle_A0/DEGREE, 3) + "°";
	ctx.fillStyle = value_color;
	ctx.fillText(text, w2, h);	
	
	h = h + dh;
	var text = "Crown parts ratio ";
	ctx.fillStyle = text_color;
	ctx.fillText(text, w1, h);		
	...
	ctx.fillStyle = text_color;
	ctx.fillText(text, w1, h);	
	text = roundNumber(angle_C0/DEGREE, 3) + "°";
	ctx.fillStyle = value_color;
	ctx.fillText(text, w2, h);
	...
	ctx.fillStyle = text_color;
	ctx.fillText(text, w1, h);	
	text = roundNumber(angle_C1/DEGREE, 3) + "°";
	ctx.fillStyle = value_color;
	ctx.fillText(text, w2, h);
	...
	ctx.fillStyle = text_color;
	ctx.fillText(text, w1, h);	
	text = roundNumber(angle_C2/DEGREE, 3) + "°";
	ctx.fillStyle = value_color;
	ctx.fillText(text, w2, h);
	...
	ctx.fillStyle = text_color;
	ctx.fillText(text, w1, h);	
	text = roundNumber(hMiddleFacet*100, 3) + "%";
	ctx.fillStyle = value_color;
	ctx.fillText(text, w2, h);
...
function print_text_index(index) // 100, 130, 160
{
	...
	if (index == 49)
	{
		ctx.fillText("  Pavilion facet  D0-1", left_2, h1);
	}
	if (index == 50)
	{
		ctx.fillText("  Pavilion facet  D0-2", left_2, h1);
	}	
	
	if (index == 51)
	{
		ctx.fillText("  Pavilion facet  D1-1", left_2, h1);
	}
	if (index == 52)
	{
		ctx.fillText("  Pavilion facet  D1-2", left_2, h1);
	}	
	if (index == 53)
	{
		ctx.fillText("  Pavilion facet  D2-1", left_2, h1);
	}
	if (index == 54)
	{
		ctx.fillText("  Pavilion facet  D2-2", left_2, h1);
	}	
	if (index == 45)
	{
		ctx.fillText("  Pavilion facet  D3-1", left_2, h1);
	}
	if (index == 56)
	{
		ctx.fillText("  Pavilion facet  D3-2", left_2, h1);
	}	
	if (index == 57)
	{
		ctx.fillText("  Pavilion facet  D4-1", left_2, h1);
	}
	if (index == 58)
	{
		ctx.fillText("  Pavilion facet  D4-2", left_2, h1);
	}	
	if (index == 59)
	{
		ctx.fillText("  Pavilion facet  D5-1", left_2, h1);
	}
	if (index == 60)
	{
		ctx.fillText("  Pavilion facet  D5-2", left_2, h1);
	}	
	if (index == 61)
	{
		ctx.fillText("  Pavilion facet  D6-1", left_2, h1);
	}
	if (index == 62)
	{
		ctx.fillText("  Pavilion facet  D6-2", left_2, h1);
	}	
	if (index == 63)
	{
		ctx.fillText("  Pavilion facet  D7-1", left_2, h1);
	}
	if (index == 64)
	{
		ctx.fillText("  Pavilion facet  D7-2", left_2, h1);
	}	
